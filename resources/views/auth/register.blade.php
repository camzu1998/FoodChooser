...
{{--            </div>--}}
            <div class="info-area info-horizontal">
                ...
                <div class="description">
                    <h3 class="info-title">{{ __('Price') }}</h3>
                    <p class="description">
                        {{ __('Food Chooser it\'s completly free.') }} <i class="tim-icons icon-satisfied"></i>
                    </p>
                </div>
            </div>
            <div class="info-area info-horizontal">
                ...
                <div class="description">
                    <h3 class="info-title">{{ __('Limitations') }}</h3>
                    <p class="description">
                        {{ __('Account is limited by 6 meals and 75 dishes.') }}
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-7 mr-auto">
            <div class="card card-register">
                <div class="card-header">
                    ...
                    <h4 class="card-title text-white ml-1">{{ __('Register') }}</h4>
                </div>
